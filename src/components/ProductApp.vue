<template>
  ...
  <div class="container mydiv">
    <div class="row">
      <div class="col col-sm-2 rep" v-for="(item, i) in items" :key="item.name">
        <!-- bbb_deals -->
        <div class="bbb_deals">
          <div class="bbb_deals_title">{{ item.name }}</div>
          <div class="bbb_deals_slider_container">
            <div class="bbb_deals_item">
              <div class="bbb_deals_image">
                <img v-bind:src="item.image" alt="robots" />
              </div>
              <div class="bbb_deals_content">
                ...
                >
                  <div class="bbb_deals_item_name">
                    <p class="fontt">
                      <span style="color: green"><b>LKR </b> - </span
                      >{{ item.price }}
                    </p>
                  </div>
                ...
                <div class="available">
                  ...
                  >
                    <div class="available_title">
                      Available: <span>{{ item.stock }}</span>
                    </div>
                  </div>
           ...
           <span class="  top-0 start-100 translate-middle  "> 
